...
GitHub Actions |
:---: |
[![GitHub Actions](https://github.com/TheAngryByrd/dotnet-drama/workflows/Build%20master/badge.svg)](https://github.com/TheAngryByrd/dotnet-drama/actions?query=branch%3Amaster) |
[![Build History](https://buildstats.info/github/chart/TheAngryByrd/dotnet-drama)](https://github.com/TheAngryByrd/dotnet-drama/actions?query=branch%3Amaster) |

## NuGet 

Package | Stable | Prerelease
--- | --- | ---
dotnet-drama | [![NuGet Badge](https://buildstats.info/nuget/dotnet-drama)](https://www.nuget.org/packages/dotnet-drama/) | [![NuGet Badge](https://buildstats.info/nuget/dotnet-drama?includePreReleases=true)](https://www.nuget.org/packages/dotnet-drama/)
